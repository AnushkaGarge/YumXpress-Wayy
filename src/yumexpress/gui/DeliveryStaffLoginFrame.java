...
public class DeliveryStaffLoginFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/yumexpress/icons/staff_login.png"))); // NOI18N
        ...
        txtStaffEmail.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        ...
        jLoginPassword.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(jLoginPassword, javax.swing.GroupLayout.PREFERRED_SIZE, 444, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtStaffEmail, javax.swing.GroupLayout.PREFERRED_SIZE, 444, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(96, 96, 96))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(120, 120, 120)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jLabel4)
                .addGap(37, 37, 37)
                .addComponent(txtStaffEmail, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(90, 90, 90)
                .addComponent(jLabel5)
                .addGap(32, 32, 32)
                .addComponent(jLoginPassword, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        if(!validateInputs()){
            JOptionPane.showMessageDialog(null, "Email/password cannot be left blank");
            return;
        }
        try{
            String staffMail = txtStaffEmail.getText().trim();
            String password = String.valueOf(jLoginPassword.getPassword()).trim();
            password = PasswordEncryption.getEncryptedPassword(password);
            StaffPojo comp = StaffDao.validate(staffMail, password);
            if(comp==null){
                JOptionPane.showMessageDialog(null,"Invalid EmailId/password. Try again");
                return;
            }
            StaffProfile.setCompanyId(comp.getCompanyId());
            StaffProfile.setStaffId(comp.getStaffId());
            StaffProfile.setStaffName(comp.getStaffName());
            StaffProfile.setEmailId(comp.getEmailId());
    ...
    private boolean validateInputs(){
        if(txtStaffEmail.getText().trim().isEmpty() || String.valueOf(jLoginPassword.getPassword()).trim().isEmpty()){
            return false;
        }
        return true;
    }
