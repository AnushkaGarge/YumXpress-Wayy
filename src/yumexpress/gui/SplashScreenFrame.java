...
public class SplashScreenFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/yumexpress/icons/loading.png"))); // NOI18N

        jLabel3.setFont(new java.awt.Font("Bell MT", 1, 24)); // NOI18N
        jLabel3.setText("Developed by Anushka Garge");

        jProgressBar1.setBackground(new java.awt.Color(204, 204, 255));
        jProgressBar1.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
    ...
    class SplashThread extends Thread{
        public void run(){
            ...
            while(jProgressBar1.getValue()<jProgressBar1.getMaximum()){
                ...
                count = count+obj.nextInt(1000);
                try{
                    Thread.sleep(1000);
                }
                catch(InterruptedException ex){
                    JOptionPane.showMessageDialog(null,"Error in Splash Thread");
                    ex.printStackTrace();
                }
            }
